...
export task=${1:-direct73_augmented_psi0textop}
export exp=${2:-movepick-direct73-textop}
...
--data.transform.repack.action-key=action.direct73 \
--data.transform.repack.pad-action-dim=73 \
--data.transform.repack.pad-state-dim=49 \
--data.transform.field.stat-path=meta/stats.json \
--data.transform.field.stat-action-key=action.direct73 \
...
--data.transform.field.pad-action-dim=73 \
