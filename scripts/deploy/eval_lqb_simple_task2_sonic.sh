...
GR00T_MODEL_PATH=/home/ubuntu/yzh/ckpt/gr00tn17/task2_isaac_sonic_lqb-male/checkpoint-60000 \
...
ISAAC_TRAINING_LIGHTING_MANIFEST=/home/ubuntu/yzh/HumanoidVLA_MJ_backup/HumanoidVLA_MJ/output/task2_lqb_isaac_lerobot/scene3/task2_lqb_all_groot_sonic_release_train_male/meta/lighting.jsonl \
...
TASK2_TRASH_TRANSLATE="-0.01 0.03 0.0" \
...
RUN_TAG=lqb_sonic_run001_ckpt60k_tl-130-eps100
...
GR00T_EXECUTION_HORIZON=40 \
GR00T_PORT=22095 \
GR00T_SONIC_TASK=G1Fullstate20260805Task2-v0 \
GR00T_SONIC_EVAL_DIR="/home/ubuntu/yzh/Psi0_kimodo_textop/third_party/SIMPLE/data/evals_task2_lqb_isaac_${RUN_TAG}" \
TASK2_RECORDINGS_DIR=/home/ubuntu/yzh/mujoco_recordings/20260805_task2_male_lqb \
...
TASK2_TRASH_TRANSLATE="-0.01 0.03 0.0" \
TASK2_BOTTLE_TRANSLATE="0.03 0.0 0.0" \
SIM_MODE=mujoco_external_isaac \
EXTERNAL_ISAAC_UDP_PORT=23331 \
EXTERNAL_ISAAC_EGO_FRAME_PATH=/dev/shm/simple_task2_isaac_ego.frame \
...
# 随机顺序由 TASK2_RECORDING_SEED=6 固定；同一 seed 会复现相同 episode 顺序。
