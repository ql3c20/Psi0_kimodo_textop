...
export TASK_NUMBER=4
export FULLSTATE_GR00T_TASK=G1Fullstate20260729Task4-v0
export TASK_RECORDINGS_DIR="${TASK_RECORDINGS_DIR:-/home/ubuntu/yzh/mujoco_recordings/20260729_task4}"
...
export GR00T_MODEL_PATH="${GR00T_MODEL_PATH:-/home/ubuntu/yzh/ckpt/gr00tn17/task4_newbg}"
