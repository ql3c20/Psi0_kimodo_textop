...
TASK_RECORDINGS_DIR=/home/ubuntu/yzh/mujoco_recordings/20260729_task4_lqb \
SERVE_GPU=0 \
GR00T_PORT=22085 \
GR00T_PREFIX_RTC=1 \
GR00T_USE_RTC=1 \
...
GR00T_MODEL_PATH=/home/ubuntu/yzh/ckpt/gr00tn17/task4_isaac_overlap12_gt-ki-tp_lqb/checkpoint-60000 \
...
TASK_RECORDINGS_DIR=/home/ubuntu/yzh/mujoco_recordings/20260729_task4_lqb \
TASK_HSSD_USD=/home/ubuntu/yzh/Psi0_kimodo_textop/third_party/SIMPLE/data/scenes/hssd/102344280/102344280.usd \
ISAAC_HEADLESS=1 \
ISAAC_UDP_PORT=23331 \
ISAAC_EGO_FRAME_PATH=/dev/shm/simple_task4_isaac_ego.frame \
ISAAC_LIGHT_RIG=scripted \
ISAAC_RANDOMIZE_LIGHTING=0 \
ISAAC_TRAINING_LIGHTING_MANIFEST=/home/ubuntu/yzh/Psi0_kimodo_textop/scripts/deploy/task4_lqb_lighting_eval_aligned.jsonl \
...
ISAAC_OUTPUT_DIR=/home/ubuntu/yzh/HumanoidVLA_MJ_backup/HumanoidVLA_MJ/output/task4_isaac_hssd_scene3 \
...
RUN_TAG=lqb_run001_ckpt60k_100k
...
TASK4_RECORDING_INDEX= \
TASK4_RECORDING_SEED=42 \
...
SAVE_VIDEO=1 \
FULLSTATE_GR00T_EVAL_DIR="/home/ubuntu/yzh/Psi0_kimodo_textop/third_party/SIMPLE/data/evals_task4_lqb_isaac_${RUN_TAG}" \
FULLSTATE_GR00T_KIMODO_WORK_DIR="/home/ubuntu/yzh/Psi0_kimodo_textop/outputs/kimodo_task4_lqb_isaac_${RUN_TAG}" \
bash scripts/deploy/fullstate_task4_gr00t_rot6d59_kimodo_textop_eval.sh eval
```

# 固定第 0 条 recording：将 TASK4_RECORDING_INDEX= 改成 TASK4_RECORDING_INDEX=0。
# 随机顺序由 TASK4_RECORDING_SEED=42 固定；同一 seed 会复现相同 episode 顺序。
