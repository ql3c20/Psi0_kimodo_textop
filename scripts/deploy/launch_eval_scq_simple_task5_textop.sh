...
MEMO="${ROOT}/scripts/deploy/eval_scq_simple_task5_textop.sh"
SELF="${ROOT}/scripts/deploy/launch_eval_scq_simple_task5_textop.sh"
...
case "${1:-}" in
  ...
  "")
    ...
    rm -f /dev/shm/simple_task5_isaac_ego.frame
    gnome-terminal --window --title="Task5 TextOp - GR00T" -- bash "$SELF" --run-block 1
    gnome-terminal --window --title="Task5 TextOp - Kimodo" -- bash "$SELF" --run-block 2
    gnome-terminal --window --title="Task5 TextOp - Isaac Ego" -- bash "$SELF" --run-block 3
    gnome-terminal --window --title="Task5 TextOp - Eval" -- bash "$SELF" --run-block 4
    ;;
