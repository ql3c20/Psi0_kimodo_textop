...
GR00T_MODEL_PATH=/home/ubuntu/yzh/ckpt/gr00tn17/task4_isaac_sonic_lqb/checkpoint-60000 \
...
# Readiness (must show prediction_horizon=40 and prefix_rtc=false):
...
GR00T_EXECUTION_HORIZON=40 \
GR00T_PORT=22095 \
GR00T_SONIC_EVAL_DIR="/home/ubuntu/yzh/Psi0_kimodo_textop/third_party/SIMPLE/data/evals_task4_lqb_isaac_${RUN_TAG}" \
TASK4_RECORDINGS_DIR=/home/ubuntu/yzh/mujoco_recordings/20260729_task4_lqb \
